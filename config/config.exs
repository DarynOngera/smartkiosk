...
config :smart_kiosk_web, SmartKioskWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SmartKioskWeb.ErrorHTML, json: SmartKioskWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: SmartKiosk.PubSub,
  live_view: [signing_salt: "Av1mU1Cy"]
...
config :esbuild,
  ...
  smart_kiosk_web: [
    ...
    cd: Path.expand("../apps/smart_kiosk_web/assets", __DIR__),
...
config :tailwind,
  ...
  smart_kiosk_web: [
    ...
    cd: Path.expand("../apps/smart_kiosk_web", __DIR__)
  ]
